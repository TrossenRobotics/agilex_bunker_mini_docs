...
project = 'AgileX BUNKER MINI Documentation'
...
html_title = "AgileX BUNKER MINI Documentation"
...
html_logo = "_images/logo_bunker_mini.png"
...
html_context = {
    ...
    'github_repo': 'agilex_bunker_mini_docs', # Repo name
...
htmlhelp_basename = 'AgileXBUNKERMINIDocumentation'
